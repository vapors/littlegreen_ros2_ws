...
1. [`INSTALL_ORANGE_PI.md`](INSTALL_ORANGE_PI.md) — install ROS 2, dependencies, ONNX Runtime, build the workspace, and configure the shell.
2. [`FRESH_INSTALL_CHECKLIST.md`](FRESH_INSTALL_CHECKLIST.md) — verify the host, UART, driver, maintenance tools, IMU boundary, and runtime-safe topic surface.
3. [`COMMISSIONING.md`](COMMISSIONING.md) — concise commissioning sequence and release gates.
...
- [`VALIDATION.md`](VALIDATION.md) — checks performed for the current documentation refresh.

## Historical records

Historical release, validation, migration, and implementation notes are indexed under:
